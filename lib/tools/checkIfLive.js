...
function checkIfLive(bot) {
    ...
    for (const ids in config) {
        ...
        //} 
        urls.push(`https://api2.musical.ly/aweme/v1/aweme/detail/?&aweme_id=${config[ids].last_post}&device_id=6617585804464326150&channel=googleplay&aid=1233&app_name=musical_ly&version_code=100400&version_name=10.4.0&device_platform=android&ab_version=10.4.0&ssmix=a&device_type=Pixel+2+XL&device_brand=google&os_api=28&os_version=9`);
    }
