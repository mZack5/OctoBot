...
exports.commands = {
  ...
  "say": {
    help: "Repeat after a user",
    process: function (message, args, command, bot) {
      message.channel.send(args.join(' '));
    }
  },
  "sayd": {
    help: "Repeat after a user and delete the users message",
    process: function (message, args, command, bot) {
      // do sanity checks to check for permisions
  ...
  "musicsettings": {
    help: "Dont touch",
    process: function (message, args, command, bot) {
      message.channel.send('I remember you when you were little, so young, so gay.');
    }
  },
  "getid": {
    help: "Get the ID of the user who sent this command",
    process: function (message, args, command, bot) {
      message.channel.send(`Your ClientID is ${message.author.id}`);
    }
  },
  "test": {
    help: "Get the ID of the user who sent this command",
    process: function (message, args, command, bot) {
      message.channel.send('test').then(msg => msg.delete(1000));
      //      message.delete(5000);
    }
  },
  /** 
